...
public class TravelingSalesmanHeldKarp {
   ...
   ArrayList<String> newTour ;
    ArrayList<String> Address ;
    private static int INFINITY = 100000000;
    ArrayList<String> joiner = new ArrayList<>() ;
    ...
    public void AddLoction (String loc)
    {
        Address.add(loc) ;
    }
    ...
    public ArrayList getTour()
    {
        for (int i = 0 ; i<joiner.size() ; i++)
            newTour.add(Address.get(Integer.parseInt(joiner.get(i))));
        newTour.add(Address.get(0));

        return newTour;

    }
    public ArrayList getToureIntArr ()
    {
